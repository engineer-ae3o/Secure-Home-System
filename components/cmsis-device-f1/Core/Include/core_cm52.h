...
#define TPIU_ITFTTD0_ATB_IF2_bytecount_Msk                                                                                                 \
    (0x3UL << TPIU_ITFTTD0_ATB_IF2_bytecount_Pos) /*!< TPIU ITFTTD0: ATB Interface 2 byte count Mask */
...
#define TPIU_ITFTTD0_ATB_IF1_bytecount_Msk                                                                                                 \
    (0x3UL << TPIU_ITFTTD0_ATB_IF1_bytecount_Pos) /*!< TPIU ITFTTD0: ATB Interface 1 byte countt Mask */
...
#define TPIU_ITFTTD1_ATB_IF2_bytecount_Msk                                                                                                 \
    (0x3UL << TPIU_ITFTTD1_ATB_IF2_bytecount_Pos) /*!< TPIU ITFTTD1: ATB Interface 2 byte count Mask */
...
#define TPIU_ITFTTD1_ATB_IF1_bytecount_Msk                                                                                                 \
    (0x3UL << TPIU_ITFTTD1_ATB_IF1_bytecount_Pos) /*!< TPIU ITFTTD1: ATB Interface 1 byte countt Mask */
...
#define DCB_DAUTHCTRL_INTSPNIDEN_Msk                                                                                                       \
    (1UL << DCB_DAUTHCTRL_INTSPNIDEN_Pos) /*!< DCB DAUTHCTRL: Internal Secure non-invasive debug enable Mask */
...
#define DCB_DAUTHCTRL_SPNIDENSEL_Msk                                                                                                       \
    (1UL << DCB_DAUTHCTRL_SPNIDENSEL_Pos) /*!< DCB DAUTHCTRL: Secure non-invasive debug enable select Mask */
...
#define ARMCM52_PMU_AXI_SAHB_WRITE_ACCESS                                                                                                  \
    0xC302 /*!< M-AXI configuration: Any beat access to the M-AXI write interface.M-AHB configuration: Any write beat access to the SYS-AHB interface */
#define ARMCM52_PMU_AXI_SAHB_READ_ACCESS                                                                                                   \
    0xC303 /*!< M-AXI configuration: Any beat access to the M-AXI read interface.M-AHB configuration: Any read beat access to the SYS-AHB interface */
#define ARMCM52_PMU_DOSTIMEOUT_DOUBLE                                                                                                      \
    0xC400 /*!< Denial of Service timeout has fired twice and caused buffers to drain to allow forward progress */
#define ARMCM52_PMU_DOSTIMEOUT_TRIPLE                                                                                                      \
