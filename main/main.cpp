...
namespace {
    ...
    pad::keypad_t<config::QUEUE_SIZE> keypad{};
    nc::switch_t<nc::type_t::REED>    reed{};
    nc::switch_t<nc::type_t::LIMIT>   tamper{};

    // Needed to serialize use of the display
    SemaphoreHandle_t lcd_mutex{};
    StaticSemaphore_t lcd_mutex_buffer{};

    // Thread safe LCD helper
    [[maybe_unused]] void print(const std::string_view& str, uint8_t line) {
    ...
    /**
    [[noreturn]] void keypad_task(void* arg) {
        UNUSED(arg);
    ...
    [[noreturn]] void lcd_task(void* arg) {
        UNUSED(arg);
    ...
    */
    ...
    std::array<StackType_t, 1024> led_task_stack{};
    StaticTask_t                  led_task_tcb{};

    //std::array<StackType_t, 512> lcd_task_stack{};
    //StaticTask_t                 lcd_task_tcb{};
    //
    //std::array<StackType_t, 512> gsm_task_stack{};
    //StaticTask_t                 gsm_task_tcb{};
    //
    //std::array<StackType_t, 512> keypad_task_stack{};
    //StaticTask_t                 keypad_task_tcb{};
    //
    //std::array<StackType_t, 512> switch_task_stack{};
    //StaticTask_t                 switch_task_tcb{};
